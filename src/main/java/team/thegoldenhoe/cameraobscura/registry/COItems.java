...
public class COItems {
	...
	public static final Item DIGITAL_CAMERA = register("digital_camera", new CameraItem(new Settings().maxCount(1)));
	public static final Item POLAROID_CAMERA = register("polaroid_camera", new CameraItem(new Settings().maxCount(1)));
	public static final Item YE_OLDE_CAMERA = register("ye_olde_camera", new CameraItem(new Settings().maxCount(1)));

	public static final Item SD_CARD = register("sd_card", new ItemSDCard(new Settings().maxCount(1)));
	public static final Item POLAROID_STACK = register("polaroid_stack", new ItemPolaroidStack(new Settings().maxCount(1)));
	public static final Item POLAROID_PHOTO = register("polaroid_photo", new ItemPolaroidSingle(new Settings().maxCount(1)));
	public static final Item VINTAGE_PHOTO = register("vintage_photo", new ItemVintagePaper(new Settings().maxCount(1)));
	...
	public static final Item FRAME_BRUSH = register("frame_brush", new FrameBrushItem(new Settings().maxCount(1)));

	private static Item registerFilter(String name, PhotoFilter filter) {
		return register(name, new ItemFilter(new Settings().maxCount(1)));
	}
